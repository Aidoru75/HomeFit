...
export const defaultRoutinesFree = [
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('overhead_press_standing', 3, 8),
          ex('hammer_curl', 3, 12),
  ...
  // ------------------------------------------
  {
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ex('back_squat', 4, 10),
          ex('romanian_deadlift_barbell', 3, 10),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('hammer_curl', 3, 12),
          ex('db_overhead_extension_two', 3, 10),
          ex('rear_delt_fly_bent', 3, 15),
        ],
      },
      {
        ...
        exercises: [
          ...
          ex('standing_calf_raise_dumbbell', 4, 15),
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('pullups_wide', 4, 5),
          ex('close_grip_bench', 3, 8),
          ex('hanging_knee_raise', 3, 10),
        ],
      },
      {
        name: 'Day 3', customName: '',
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('dumbbell_row', 4, 8),
          ex('hammer_curl', 3, 8),
          ex('db_overhead_extension_two', 3, 8),
        ],
      },
      {
        ...
        exercises: [
          ...
          ex('bulgarian_split_squat_db', 3, 8),
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('lateral_raise', 3, 15),
          ex('db_curl_standing', 3, 12),
          ex('db_overhead_extension_single', 3, 12),
          ex('crunches', 3, 20),
        ],
      },
      {
  ...
  // ------------------------------------------
  // HYPERTROPHY (Intermediate) - 3 days, Push/Pull/Legs
  // ------------------------------------------
  {
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('cable_curl_bar', 3, 10),
          ex('cable_pushdown_vbar', 3, 10),
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ex('deadlift', 4, 5),
          ex('overhead_press_standing', 4, 5),
          ex('lat_pulldown_wide', 4, 5),
          ex('cable_pushdown_bar', 3, 8),
          ex('leg_extension', 3, 10),
        ],
      },
      {
        name: 'Day 3', customName: '',
